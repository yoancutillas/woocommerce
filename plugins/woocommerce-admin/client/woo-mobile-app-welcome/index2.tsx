...
// states to support
// 1. no jetpack
// 2. jetpack no connected
// 3. jetpack user not connected
// intro: do you have woo mobile app installed on your phone?
// 4. pre-magic link
// 5. magic link sent -> please check your inbox on your phone


const WooMobileWelcomePage = () => {
	return <div>Welcom</div>;
}

export default WooMobileWelcomePage;